...
<body class="align">
	...
	<div class="grid">
		...
		<form name="form" action="<%=request.getContextPath()%>/LoginServlet"
			...
			<div class="form__field">
				<label for="login__password"> <img src="svg/password.svg"
					width="20px" height="20px" alt="password_logo"> <span
					class="hidden">Password</span>
				</label> <input id="login__password" type="password" name="password"
					class="form__input" placeholder="Password" required>
			</div>

			<p class="text--center">
				<span
					style="color: #4ceaae; text-transform: uppercase; font-weight: 500"><%=(request.getAttribute("errMessage") == null) ? "" : request.getAttribute("errMessage")%></span>
			</p>
